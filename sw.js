const CACHE='csi1000-pwa-v1.0.4';
const ASSETS=['./','./index.html','./manifest.webmanifest','./icon-192.png','./icon-512.png','./strategy-core.js','./market-data-core.js','./market-provider.js','./trading-calendar-2026.json','./data/csi1000-history.json'];
