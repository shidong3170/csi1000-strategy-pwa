...
assert.match(readme,/PWA V1\.0\.9/);
assert.match(githubReadme,/V1\.0\.9/);
...
assert.match(html,/schemaVersion:3,appVersion:'1\.0\.9',databaseVersion:4/);
...
assert.match(sw,/csi1000-pwa-v1\.0\.9/);
